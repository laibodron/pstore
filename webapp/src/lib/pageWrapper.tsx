...
import useLastVisitedNotAuthRouteState from './store/useLastVisistedNotAuthRoute'
...
const PageWrapper = <TProps extends Props = {}, TQueryResult extends QueryResult | undefined = undefined>({
  ...
  const lastVisistedNotAuthRoute = useLastVisitedNotAuthRouteState((s) => s.last)
  ...
  try {
    ...
    // console.log('Calculated title:', calculatedTitle)
    return (
      <>
        <Helmet>
          <title>
